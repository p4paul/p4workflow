...
public class P4Step extends SCMStep {
	...
	public static final class DescriptorImpl extends SCMStepDescriptor {
		...
		private static boolean hasMultiple(String stream, String template,
				String path) {
		...
		public FormValidation doCheckStream(@QueryParameter String value,
				@QueryParameter String template, @QueryParameter String path) {
		...
		public FormValidation doCheckTemplate(@QueryParameter String value,
				@QueryParameter String stream, @QueryParameter String path) {
			if (P4Step.notNull(value)) {
		...
		public FormValidation doCheckPath(@QueryParameter String value,
				@QueryParameter String stream, @QueryParameter String template) {
			if (P4Step.notNull(value)) {
